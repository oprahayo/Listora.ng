<x-layouts.public>
    ...
    <section class="mx-auto max-w-xl px-4 py-12 text-center sm:px-6 md:py-20">
        <span class="mx-auto flex size-12 items-center justify-center rounded-xl bg-[#EAF2FF] text-[#145FCC]"><x-icon name="lock" class="size-6" /></span>
        <h1 class="mt-6 text-[26px] font-semibold tracking-tight text-[#182230] md:text-3xl">Password recovery is currently unavailable</h1>
