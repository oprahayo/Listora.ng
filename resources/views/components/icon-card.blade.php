...
<a href="{{ $href }}" class="group flex min-h-20 flex-col items-center justify-center gap-2 rounded-lg border border-[#DFE7F3] bg-[#F7FAFF] p-2 text-center transition hover:border-[#9BB9EC] hover:bg-[#EAF2FF] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#145FCC] md:min-h-24 md:gap-3 md:p-3">
