...
<div {{ $attributes->merge(['class' => 'rounded-xl border border-dashed border-[#CBD5E1] bg-white px-6 py-12 text-center']) }}>
    <span class="mx-auto flex size-12 items-center justify-center rounded-full bg-[#EEF4FF] text-[#155EEF]"><x-icon :name="$icon" class="size-6" /></span>
    <h2 class="mt-4 text-lg font-semibold text-[#172033]">{{ $title }}</h2>
